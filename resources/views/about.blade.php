  ...
  <div id="content">
    ...
    <div id="sidebar">
      <div class="featured">
        ...
        <ul>
          <li> <a href="#"><img src="{{asset('assets/img/puppy2.jpg')}}" width="115" height="155" alt=""></a>
          ...
          <li> <a href="#"><img src="{{asset('assets/img/bird2.jpg')}}" width="115" height="155" alt=""></a>
            <h2><a href="#">Fun birds</a></h2>
            <p> Mirum est notare quam littera gothica, quam nunc putamus parum clara m, ant epo suerit li tterar. <a class="more" href="#">read more</a> </p>
          </li>
          <li class="last"> <a href="#"><img src="{{asset('assets/img/cat2.jpg')}}" width="115" height="155" alt=""></a>
